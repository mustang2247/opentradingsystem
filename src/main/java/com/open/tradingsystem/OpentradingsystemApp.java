package com.open.tradingsystem;
...
public class OpentradingsystemApp {

    private static final Logger log = LoggerFactory.getLogger(OpentradingsystemApp.class);

    private final Environment env;

    public OpentradingsystemApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes opentradingsystem.
     * <p>
