...
public class OpenApiExamples {
    ...
    private static final Logger log = LoggerFactory.getLogger(OpenApiExamples.class);
     ...
     * @param apiKeySecret
     */
    public OpenApiExamples(String apiKey, String apiKeySecret) {
        this.apiKey = apiKey;
...
//                    Log.e(TAG, errMsg, e);
    ...
    public static void main(String[] args){
        OpenApiExamples apiExamples = new OpenApiExamples();
        try {
            System.out.println(apiExamples.sendRequestV1Balances());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
