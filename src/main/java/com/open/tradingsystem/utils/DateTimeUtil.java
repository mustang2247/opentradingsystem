...
public class DateTimeUtil {
    ...
    public static int getSecondsToNextDay( long millis ) {
        long tmp = millis + DateTimeUtil.defaultZone.getOffset( millis );
    ...
    public static long getHourBeginMillis( long millis ) {
        long offset = DateTimeUtil.defaultZone.getOffset( millis );
    ...
    public static void main( String[] args ) {
        ...
        try {
            ...
            long offset = DateTimeUtil.defaultZone.getOffset( gmt );
            long local = gmt + offset;
            System.out.println( "offset = " + offset );
            System.out.println( "hourBegin = " + DateTimeUtil.getHourBeginMillis( gmt ) );
            System.out.println( "DayBegin = " + DateTimeUtil.getDayBeginMillis( gmt ) );
            System.out.println( "millisToNextHour = " + DateTimeUtil.getMillisToNextHour( gmt ) );
            System.out.println( "millisToNextDay = " + DateTimeUtil.getMillisToNextDay( gmt ) );
            System.out.println( "secondsToNextDay = " + DateTimeUtil.getSecondsToNextDay( gmt ) );
            System.out.println( "secondsToNextDay = " + DateTimeUtil.getMillisToNextDay( gmt ) / 1000 );
        }
        catch( Exception e ) {
            e.printStackTrace();
        }
